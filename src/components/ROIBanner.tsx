      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12">
          <h3 className="text-white text-2xl md:text-3xl font-semibold mb-2">
            Built for Efficiency and Compliance Support
          </h3>
          <p className="text-gray-300">Practical tools to streamline testing and documentation. Actual results vary.</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-start justify-around gap-8 md:gap-12">
          ...
          <div className="text-center max-w-xs">
            ...
            <p className="text-white text-sm md:text-base">Generate professional PDFs quickly after test completion.</p>
          </div>
